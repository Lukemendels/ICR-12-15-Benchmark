...
Two pipeline packages use compensation-loading ratios of 1.467370066 and 1.467370 with aligned source period and employee universe. Their difference is displayed precision. The first of these packages, 202601-1652-004, was pending. The comparison supports a common treatment of the formula and precision convention, not a requirement that the same ratio apply to different years or worker populations. [[CMP-06]]

The Federal Air Marshal Service (FAMS) medical package was pending at the evidence cutoff. Its published applicant estimate and the Transportation Security Officer (TSO) medical applicant statement share a $32.66 mean wage, a 1.4582 loading factor, and an 11-minute waiting assumption for the compared applicant component. Provider compensation and incumbent Federal employee travel have different actor boundaries. The agreement does not resolve the separate travel-proxy questions discussed in Section 6. [[CMP-08]]
